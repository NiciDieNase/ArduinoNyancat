...
for thisNote in {0..215}; do
	beep -f ${melody[$thisNote]} -l $((1700/${melodyDurations[$thisNote]}))
	echo "$thisNote beep -f ${melody[$thisNote]} -l $((1700/${melodyDurations[$thisNote]}))"
	beep -f 0 -l $(((1700/${melodyDurations[$thisNote]})/3))
	done;
